...
namespace NotesAndReminders.DataBase.Migrations
{
    ...
    [Migration("20240304143845_creataManyToManyTageNote")]
    partial class creataManyToManyTageNote
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotesAndReminders.DataBase.Models.NoteTag", b =>
                {
                    b.Property<int>("NoteId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NotesAndReminders.DataBase.Models.NoteTag", b =>
                {
                    ...
                    b.HasOne("NotesAndReminders.DataBase.Models.Tage", "Tag")
                        .WithMany("NoteTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
